...
export default function ProductShowcase({ product }: { product: ProductDTO }) {
    ...
    const accessories = products?.filter((p) => product.accessory_ids ? product.accessory_ids.includes(p._id) : []);
    ...
    return (
        <>
            ...
            {screens === "norms" ? <Row className="mt-3 pt-3 border-t-2">
