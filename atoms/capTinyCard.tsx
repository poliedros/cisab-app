...
export default function CapTinyCard({
    ...
    return (
        ...
        <div className="flex items-center justify-center flex-column">
            ...
            >
                <Card
                    className="rot-minus-45 !rounded-3xl pt-4" bg={baseColor === "dark" ? "dark" : "white"}
                >
                    <Card.Body className="!pl-12">
                      <Row className="!flex-nowrap"><Col xs={8}>
                        <Card.Title className={"" + baseColor === "dark" ? "text-white" : ""} >Nome</Card.Title>
                        <Card.Text>porra do saco</Card.Text>
                        </Col>
                        <Col xs={4}>
                        <CapIconButton size="14px" fill={baseColor === "dark" ? "green" : ""} />
